...
// import { ChangeEvent, FocusEvent, lazy, Suspense, useCallback, useEffect, useRef, useState } from "react";
...
//             const importedData = rows.map((row, i) => {
//                 const cells = row.split(",").slice(0, COLUMN_LIMIT);

//                 return cells.map((cellData, j) => ({
//                     id: `${i}-${j}`,
//                     cellData: cellData || "",
//                     bgColor: "#ffffff",
//                     textColor: "#000000",
